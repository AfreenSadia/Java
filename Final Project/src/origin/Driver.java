...
public class Driver extends General{
	...
	protected long nid;
	protected String driving_licence;

	@Override
	public void information() {
		
		File file = new File("Driver Registration");
		file.mkdir();
		
	do {
		
	try {
		Formatter store = new Formatter("F:/Work and Projects/Women Ride Sharing Management System/Driver Registration/Driver Information.txt");
		...
		long nid = this.nid;
		String driving_licence = this.driving_licence;
		...
		System.out.println("");
		System.out.println("\t----------------------------------------------------------");
		System.out.println("\t\t*****WELCOME TO DRIVER REGISTRATION*****");
		System.out.println("\t----------------------------------------------------------");
		System.out.println("");
		...
		this.driving_licence = input.nextLine();
		store.format("\r\nDriving License: "+this.driving_licence);
		...
		if(super.password.equals(super.rpassword) && super.confirm.equalsIgnoreCase(super.agree)) {
